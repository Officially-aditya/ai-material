...
print("\nDrift Detection Results (Kolmogorov-Smirnov Test, alpha=0.05):")
print("-" * 70)
...
for feature in features:
    ...
    status = "[!] YES" if is_drifted else "(ok) No"
...
print("-" * 70)
print(f"\n[ALERT] {len(drifted_features)} features show significant drift: {drifted_features}")
...
print(f"\n[OK] Retrained model performance on new 2024 data:")
...
for idx, feature in enumerate(features):
    ...
    ax.set_title(f'{feature}\n({"[!] DRIFTED" if feature in drifted_features else "(ok) Stable"})')
...
----------------------------------------------------------------------
word_count           [!] YES     0.000001     0.85         0.234
link_count           [!] YES     0.000023     0.42         0.189
urgent_words         [!] YES     0.001245     0.38         0.156
money_mentions       (ok) No       0.089234     0.21         0.098
sender_reputation    [!] YES     0.000089     0.52         0.201
----------------------------------------------------------------------

[ALERT] 4 features show significant drift: ['word_count', 'link_count', 'urgent_words', 'sender_reputation']
